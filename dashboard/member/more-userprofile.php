...
if (isset($_POST['submit'])) {
    ...
    $query = "UPDATE users SET username='$usrname', Full_name='$fulname' WHERE adminid='$userid'";
    ...
    if (isset($_FILES['image'])) {
        ...
        $sql_check = "SELECT image_path FROM images WHERE userid = '$userid'";
        ...
        if (mysqli_num_rows($result_check) > 0) {
            ...
            if ($uploadOk == 0) {
                ...
                if (move_uploaded_file($_FILES["image"]["tmp_name"], $target_file)) {
                    ...
                    $sql_insert = "INSERT INTO images (imageid, userid, image_path) VALUES (UUID(), '$userid', '$target_file')";
