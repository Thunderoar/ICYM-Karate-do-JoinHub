      ...
      $result=mysqli_query($con,$query1);
        ...
        if($result){
          ...
          if(mysqli_query($con,$query2)==1){
            ...
            $query4="insert into health_status(healthid,userid) values('$healthID', '$memID')";
            if(mysqli_query($con,$query4)==1){

              $query5="insert into address(addressid,userid,streetName,state,city,zipcode) values('$addressID','$memID','$stname','$state','$city','$zipcode')";
