...
INSERT INTO `plan` (`planid`, `planName`, `description`, `validity`, `amount`, `active`) VALUES
('BJEFSY', 'Karate Activities', 'This includes all karate activity plan', 'Lifetime', 20, 'yes');
