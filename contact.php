    ...
    <div class="row">
      ...
      <div class="col-lg-4 ml-auto">
        <div class="p-4 mb-3 bg-white">
          ...
          <p class="mb-4 text-black" id="contactAddress"></p>

          <p class="mb-0 font-weight-bold text-black">Phone</p>
          <p class="mb-4"><a href="#" id="contactPhone"></a></p>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    async function handleSubmit(e) {
        ...
        try {
            ...
            const response = await fetch('dashboard/admin/contact_process.php', {
                method: 'POST',
                body: formData
            });
            ...
            showMessage('Connection error. Please check your Database and try again.', 'danger');
